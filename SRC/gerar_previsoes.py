...
def gerar_previsoes_modelo():
    ...
    clf = joblib.load('Models/modelo_treinado_fraude.pk')
    
    
    
    print("Gerando Previsões...")

    df_original = pd.read_csv("Data/Processed/novos_dados.csv")
    ...
    df_original.to_excel('Data/Final/previsoes_fraude.xlsx')
